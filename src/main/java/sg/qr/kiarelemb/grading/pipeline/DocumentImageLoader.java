...
public final class DocumentImageLoader {
	...
	public static List<File> sortedAnswerImages(File directory) throws IOException {
		...
		if (imageFiles != null && imageFiles.length > 0) {
			...
			sortedImages.sort(DocumentImageLoader::compareByName);
			return sortedImages;
		}
	...
	public static List<File> convertedPdfImages(File pdfFile) {
		...
		images.sort(DocumentImageLoader::compareByName);
		return images;
	}
	...
	public static List<File> renderedPdfImagesForDirectory(File directory) {
		...
		renderedImages.sort(DocumentImageLoader::compareByName);
