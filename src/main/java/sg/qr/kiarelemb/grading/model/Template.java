...
public record Template(String name, File pictureFile, AnswerSheet answerSheet,
	...
	private static SubjectiveRegion defaultSubjectiveRegion(Rect rect, AnswerSheet answerSheet) {
		...
		return new SubjectiveRegion("主观题1", start, start + count - 1, rect,
				SubjectiveRegion.GradingMode.OCR, java.math.BigDecimal.ZERO);
	}
}
