...
public final class ChoiceCheckTextPane extends CheckTextPane {
	public static final ChoiceCheckTextPane CHOICE_CHECK_TEXT_PANE = new ChoiceCheckTextPane();

	private ReviewDataChangeListener reviewDataChangeListener;

	private ChoiceCheckTextPane() {
