...
public class NewGradingProjectDialog extends QRDialog {
	...
	public NewGradingProjectDialog() {
		this(null, null, null);
	}

	public NewGradingProjectDialog(SheetTemplate template, File templateFile, File answerDirectory) {
	...
	private void finishSaveProject(AnswerFilePlan answerFilePlan, String projectName,
		...
		try {
			...
			GradingProject project = new GradingProject(projectFile.getAbsolutePath(), templateFile.getAbsolutePath(),
